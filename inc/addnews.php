...
HTML
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST')
	{
		...
		{
			$trust .= '<li>Поле "Заголовок новости" должно иметь не менее 8-ми символов</li>';
		}
		if(mb_strlen($shortDescription) < 30)	
		{
			$trust .= '<li>Поле "Краткое описание" должно иметь не менее 30 символов</li>';
		}
		if(mb_strlen($fullDescription) < 30) 
		{
			$trust .= '<li>Поле "Полное описание" должно иметь не менее 30 символов</li>';
		}
